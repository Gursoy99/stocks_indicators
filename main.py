...
#Stocks for NASDAQ or BINANCE
def Stocks(name):
    Stock_names = ''
    if name == 'NASDAQ':
        Stock_names = get_all_symbols(market='america')
        Stock_names = [symbol.replace('NASDAQ:', '') for symbol in Stock_names]
...
#Download Stocks from #NASDAQ or BINANCE
